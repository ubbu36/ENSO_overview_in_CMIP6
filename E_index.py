...
#for x in range(0,len(model_names_1)):
for x in range(0,len(model_names_1)):
    ens1=xr.open_dataset('/Users/ullaheede_1/Downloads/E_index_proj'+model_names_1[x]+'_4x.nc')
#    ens1=xr.open_dataset('/Users/ullaheede_1/Downloads/E_index'+model_names_1[x]+'_14x.nc')
...
for x in range(0,len(model_names)):
    ...
    ens1=xr.open_dataset('/Users/ullaheede_1/Downloads/E_index'+model_names[x]+'_piControl.nc')
 ...
 #   ens1=4*(ens1-ens1.min('time'))/(ens1.max('time')-ens1.min('time'))-2
    ...
    ens1=xr.open_dataset('/Users/ullaheede_1/Downloads/E_index_proj'+model_names[x]+'_1pct.nc')
#    ens1=xr.open_dataset('/Users/ullaheede_1/Downloads/E_index'+model_names[x]+'_1pct.nc')  
    ens1=ens1['pseudo_pcs'].isel(time=slice(0,150*12))
 ...
 #   ens1=4*(ens1-ens1.min('time'))/(ens1.max('time')-ens1.min('time'))-2
    ...
    ens1=xr.open_dataset('/Users/ullaheede_1/Downloads/E_index_proj'+model_names[x]+'_ssp585_1.nc')
#    ens1=xr.open_dataset('/Users/ullaheede_1/Downloads/E_index'+model_names[x]+'_ssp585_1.nc')
  ...
  #  ens1=4*(ens1-ens1.min('time'))/(ens1.max('time')-ens1.min('time'))-2
    ...
    ens1=xr.open_dataset('/Users/ullaheede_1/Downloads/E_index_proj'+model_names[x]+'_ssp585_2.nc')
#    ens1=xr.open_dataset('/Users/ullaheede_1/Downloads/E_index'+model_names[x]+'_ssp585_2.nc')
 ...
 #   ens1=4*(ens1-ens1.min('time'))/(ens1.max('time')-ens1.min('time'))-2
    ...
    ens1=xr.open_dataset('/Users/ullaheede_1/Downloads/E_index_proj'+model_names[x]+'_ssp585_3.nc')
  #  ens1=xr.open_dataset('/Users/ullaheede_1/Downloads/E_index'+model_names[x]+'_ssp585_3.nc')
...
#      ens1=xr.open_dataset('/Users/ullaheede_1/Downloads/E_index'+model_names[x]+'_ssp1_1.nc')
#    #  ens1=xr.open_dataset('/Users/ullaheede_1/Downloads/E_index'+model_names[x]+'_ssp585_1.nc')
...
#      ens1=xr.open_dataset('/Users/ullaheede_1/Downloads/E_index'+model_names[x]+'_ssp1_2.nc')
#     # ens1=xr.open_dataset('/Users/ullaheede_1/Downloads/E_index'+model_names[x]+'_ssp585_2.nc')
...
#      ens1=xr.open_dataset('/Users/ullaheede_1/Downloads/E_index'+model_names[x]+'_ssp1_3.nc')
#    # ens1=xr.open_dataset('/Users/ullaheede_1/Downloads/E_index'+model_names[x]+'_ssp585_3.nc')
