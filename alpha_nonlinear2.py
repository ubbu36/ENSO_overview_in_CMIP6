...
nino_Q=xr.open_dataset('/Users/ullaheede_1/Documents/ENSO_project/CanESM5/nino_Q_control.nc')
...
nino_Q= dsp.bandpass(nino_Q,1/(7*12),1/(1*12),dim='time')
...
ax[0].set_ylabel('net flux (Q, W/m$^2$)')
ax[0].set_title('control')
ax[0].text(0.85, 0.95, '$\\alpha$='+str("%.2f" % slope1), horizontalalignment='center', verticalalignment='center', transform=ax[0].transAxes)
ax[0].text(0.5, 0.95, '$\\alpha$='+str("%.2f" % slope2), horizontalalignment='center', verticalalignment='center', transform=ax[0].transAxes)
ax[0].text(0.15, 0.95, '$\\alpha$='+str("%.2f" % slope3), horizontalalignment='center', verticalalignment='center', transform=ax[0].transAxes)
...
nino_Q=xr.open_dataset('/Users/ullaheede_1/Documents/ENSO_project/CanESM5/nino_Q_'+yr1+'.nc')
nino_Q=nino_Q.to_array()
nino_Q=nino_Q.transpose().squeeze()
nino_Q=nino_Q.groupby('time.month')-nino_Q.groupby('time.month').mean('time')
nino_Q=nino_Q.assign_coords(time=range(0,len(nino_Q.time)))
...
ax[1].set_ylabel('net flux (Q, W/m$^2$)')
ax[1].set_title('4xCO$_2$')
ax[1].text(0.85, 0.95, '$\\alpha$='+str("%.2f" % slope1), horizontalalignment='center', verticalalignment='center', transform=ax[1].transAxes)
ax[1].text(0.5, 0.95, '$\\alpha$='+str("%.2f" % slope2), horizontalalignment='center', verticalalignment='center', transform=ax[1].transAxes)
ax[1].text(0.15, 0.95, '$\\alpha$='+str("%.2f" % slope3), horizontalalignment='center', verticalalignment='center', transform=ax[1].transAxes)
...
nino_temp=xr.open_dataset('/Users/ullaheede_1/Documents/ENSO_project/CanESM5/nino_temp_'+yr1+'.nc')
nino_temp=nino_temp['thetao'].isel(time=slice(0,12*85))
nino_temp=nino_temp.groupby('time.month')-nino_temp.groupby('time.month').mean('time')
nino_temp=nino_temp.assign_coords(time=range(0,len(nino_temp.time)))
...
nino_temp=nino_temp['thetao'].isel(time=slice(0,12*85))
nino_temp=nino_temp.groupby('time.month')-nino_temp.groupby('time.month').mean('time')
nino_temp=nino_temp.assign_coords(time=range(85*12,len(nino_temp.time)+85*12))
...
nino_temp=nino_temp['thetao'].isel(time=slice(0,12*85))
nino_temp=nino_temp.groupby('time.month')-nino_temp.groupby('time.month').mean('time')
nino_temp=nino_temp.assign_coords(time=range(0+85*12*2,len(nino_temp.time)+85*12*2))
...
nino_temp4=nino_temp4.drop('month')
...
nino_Q=xr.open_dataset('/Users/ullaheede_1/Documents/ENSO_project/CanESM5/nino_Q_'+yr1+'.nc')
nino_Q=nino_Q['__xarray_dataarray_variable__'].isel(time=slice(0,12*85))
nino_Q=nino_Q.groupby('time.month')-nino_Q.groupby('time.month').mean('time')
nino_Q=nino_Q.assign_coords(time=range(0,len(nino_Q.time)))
nino_Q_ens1= dsp.bandpass(nino_Q,1/(7*12),1/(1*12),dim='time')

nino_Q=xr.open_dataset('/Users/ullaheede_1/Documents/ENSO_project/CanESM5/nino_Q_'+yr2+'.nc')
nino_Q=nino_Q['__xarray_dataarray_variable__'].isel(time=slice(0,12*85))
nino_Q=nino_Q.groupby('time.month')-nino_Q.groupby('time.month').mean('time')
nino_Q=nino_Q.assign_coords(time=range(0+85*12,len(nino_Q.time)+85*12))
nino_Q_ens2= dsp.bandpass(nino_Q,1/(7*12),1/(1*12),dim='time')

nino_Q=xr.open_dataset('/Users/ullaheede_1/Documents/ENSO_project/CanESM5/nino_Q_'+yr3+'.nc')
nino_Q=nino_Q['__xarray_dataarray_variable__'].isel(time=slice(0,12*85))
nino_Q=nino_Q.groupby('time.month')-nino_Q.groupby('time.month').mean('time')
nino_Q=nino_Q.assign_coords(time=range(0+85*12*2,len(nino_Q.time)+85*12*2))
nino_Q_ens3= dsp.bandpass(nino_Q,1/(7*12),1/(1*12),dim='time')

nino_Q=xr.concat([nino_Q_ens1,nino_Q_ens2,nino_Q_ens3],'time')
nino_Q=nino_Q.drop('month')
...
ax[2].set_ylabel('net flux (Q, W/m$^2$)')
ax[2].set_title('SSP585 (3 ens. mem. )')
ax[2].text(0.85, 0.95, '$\\alpha$='+str("%.2f" % slope1), horizontalalignment='center', verticalalignment='center', transform=ax[2].transAxes)
ax[2].text(0.5, 0.95, '$\\alpha$='+str("%.2f" % slope2), horizontalalignment='center', verticalalignment='center', transform=ax[2].transAxes)
ax[2].text(0.15, 0.95, '$\\alpha$='+str("%.2f" % slope3), horizontalalignment='center', verticalalignment='center', transform=ax[2].transAxes)
...
nino_Q=xr.open_dataset('/Users/ullaheede_1/Documents/ENSO_project/CESM2/nino_Q_control.nc')
nino_Q=nino_Q.to_array()
nino_Q=nino_Q.transpose().squeeze()
nino_Q=nino_Q.groupby('time.month')-nino_Q.groupby('time.month').mean('time')
nino_Q=nino_Q.assign_coords(time=range(0,len(nino_Q.time)))
...
ax[3].set_ylabel('net flux (Q, W/m$^2$)')
ax[3].set_title('control')
ax[3].text(0.85, 0.95, '$\\alpha$='+str("%.2f" % slope1), horizontalalignment='center', verticalalignment='center', transform=ax[3].transAxes)
ax[3].text(0.5, 0.95, '$\\alpha$='+str("%.2f" % slope2), horizontalalignment='center', verticalalignment='center', transform=ax[3].transAxes)
ax[3].text(0.15, 0.95, '$\\alpha$='+str("%.2f" % slope3), horizontalalignment='center', verticalalignment='center', transform=ax[3].transAxes)
...
nino_Q=xr.open_dataset('/Users/ullaheede_1/Documents/ENSO_project/CESM2/nino_Q_'+yr1+'.nc')
nino_Q=nino_Q.to_array()
nino_Q=nino_Q.transpose().squeeze()
nino_Q=nino_Q.groupby('time.month')-nino_Q.groupby('time.month').mean('time')
nino_Q=nino_Q.assign_coords(time=range(0,len(nino_Q.time)))
...
ax[4].set_ylabel('net flux (Q, W/m$^2$)')
ax[4].set_title('4xCO$_2$')
ax[4].text(0.85, 0.95, '$\\alpha$='+str("%.2f" % slope1), horizontalalignment='center', verticalalignment='center', transform=ax[4].transAxes)
ax[4].text(0.5, 0.95, '$\\alpha$='+str("%.2f" % slope2), horizontalalignment='center', verticalalignment='center', transform=ax[4].transAxes)
ax[4].text(0.15, 0.95, '$\\alpha$='+str("%.2f" % slope3), horizontalalignment='center', verticalalignment='center', transform=ax[4].transAxes)
...
nino_Q=xr.open_dataset('/Users/ullaheede_1/Documents/ENSO_project/CESM2/nino_Q_'+yr2+'.nc')
nino_Q=nino_Q['__xarray_dataarray_variable__'].isel(time=slice(0,12*85))
nino_Q=nino_Q.groupby('time.month')-nino_Q.groupby('time.month').mean('time')
nino_Q=nino_Q.assign_coords(time=range(0+85*12,len(nino_Q.time)+85*12))
nino_Q_ens2= dsp.bandpass(nino_Q,1/(7*12),1/(1*12),dim='time')

nino_Q=xr.open_dataset('/Users/ullaheede_1/Documents/ENSO_project/CESM2/nino_Q_'+yr3+'.nc')
nino_Q=nino_Q['__xarray_dataarray_variable__'].isel(time=slice(0,12*85))
nino_Q=nino_Q.groupby('time.month')-nino_Q.groupby('time.month').mean('time')
nino_Q=nino_Q.assign_coords(time=range(0+85*12*2,len(nino_Q.time)+85*12*2))
nino_Q_ens3= dsp.bandpass(nino_Q,1/(7*12),1/(1*12),dim='time')
...
ax[5].set_ylabel('net flux (Q, W/m$^2$)')
ax[5].set_title('SSP585 (3 ens. mem. )')
ax[5].text(0.85, 0.95, '$\\alpha$='+str("%.2f" % slope1), horizontalalignment='center', verticalalignment='center', transform=ax[5].transAxes)
ax[5].text(0.5, 0.95, '$\\alpha$='+str("%.2f" % slope2), horizontalalignment='center', verticalalignment='center', transform=ax[5].transAxes)
ax[5].text(0.15, 0.95, '$\\alpha$='+str("%.2f" % slope3), horizontalalignment='center', verticalalignment='center', transform=ax[5].transAxes)
...
nino_Q=xr.open_dataset('/Users/ullaheede_1/Documents/ENSO_project/CNRM-CM6-1/nino_Q_control.nc')
nino_Q=nino_Q.to_array()
nino_Q=nino_Q.transpose().squeeze()
nino_Q=nino_Q.groupby('time.month')-nino_Q.groupby('time.month').mean('time')
nino_Q=nino_Q.assign_coords(time=range(0,len(nino_Q.time)))
...
ax[6].set_ylabel('net flux (Q, W/m$^2$)')
ax[6].set_title('control')
ax[6].text(0.85, 0.95, '$\\alpha$='+str("%.2f" % slope1), horizontalalignment='center', verticalalignment='center', transform=ax[6].transAxes)
ax[6].text(0.5, 0.95, '$\\alpha$='+str("%.2f" % slope2), horizontalalignment='center', verticalalignment='center', transform=ax[6].transAxes)
ax[6].text(0.15, 0.95, '$\\alpha$='+str("%.2f" % slope3), horizontalalignment='center', verticalalignment='center', transform=ax[6].transAxes)
...
nino_Q=xr.open_dataset('/Users/ullaheede_1/Documents/ENSO_project/CNRM-CM6-1/nino_Q_'+yr1+'.nc')
nino_Q=nino_Q['__xarray_dataarray_variable__'].isel(time=slice(0,12*85))
nino_Q=nino_Q.groupby('time.month')-nino_Q.groupby('time.month').mean('time')
nino_Q=nino_Q.assign_coords(time=range(0,len(nino_Q.time)))
nino_Q_ens1= dsp.bandpass(nino_Q,1/(7*12),1/(1*12),dim='time')

nino_Q=xr.open_dataset('/Users/ullaheede_1/Documents/ENSO_project/CNRM-CM6-1/nino_Q_'+yr2+'.nc')
nino_Q=nino_Q['__xarray_dataarray_variable__'].isel(time=slice(0,12*85))
nino_Q=nino_Q.groupby('time.month')-nino_Q.groupby('time.month').mean('time')
nino_Q=nino_Q.assign_coords(time=range(0+85*12,len(nino_Q.time)+85*12))
nino_Q_ens2= dsp.bandpass(nino_Q,1/(7*12),1/(1*12),dim='time')

nino_Q=xr.open_dataset('/Users/ullaheede_1/Documents/ENSO_project/CNRM-CM6-1/nino_Q_'+yr3+'.nc')
nino_Q=nino_Q['__xarray_dataarray_variable__'].isel(time=slice(0,12*85))
nino_Q=nino_Q.groupby('time.month')-nino_Q.groupby('time.month').mean('time')
nino_Q=nino_Q.assign_coords(time=range(0+85*12*2,len(nino_Q.time)+85*12*2))
nino_Q_ens3= dsp.bandpass(nino_Q,1/(7*12),1/(1*12),dim='time')
...
ax[8].set_ylabel('net flux (Q, W/m$^2$)')
ax[8].set_title('SSP585 (3 ens. mem. )')
ax[8].text(0.85, 0.95, '$\\alpha$='+str("%.2f" % slope1), horizontalalignment='center', verticalalignment='center', transform=ax[8].transAxes)
ax[8].text(0.5, 0.95, '$\\alpha$='+str("%.2f" % slope2), horizontalalignment='center', verticalalignment='center', transform=ax[8].transAxes)
ax[8].text(0.15, 0.95, '$\\alpha$='+str("%.2f" % slope3), horizontalalignment='center', verticalalignment='center', transform=ax[8].transAxes)
...
nino_Q=xr.open_dataset('/Users/ullaheede_1/Documents/ENSO_project/HadGEM3-GC31-LL/nino_Q_control.nc')
nino_Q=nino_Q.to_array()
nino_Q=nino_Q.transpose().squeeze()
nino_Q=nino_Q.groupby('time.month')-nino_Q.groupby('time.month').mean('time')
nino_Q=nino_Q.assign_coords(time=range(0,len(nino_Q.time)))
...
ax[9].set_ylabel('net flux (Q, W/m$^2$)')
ax[9].set_title('control')
ax[9].text(0.85, 0.95, '$\\alpha$='+str("%.2f" % slope1), horizontalalignment='center', verticalalignment='center', transform=ax[9].transAxes)
ax[9].text(0.5, 0.95, '$\\alpha$='+str("%.2f" % slope2), horizontalalignment='center', verticalalignment='center', transform=ax[9].transAxes)
ax[9].text(0.15, 0.95, '$\\alpha$='+str("%.2f" % slope3), horizontalalignment='center', verticalalignment='center', transform=ax[9].transAxes)
...
nino_Q=xr.open_dataset('/Users/ullaheede_1/Documents/ENSO_project/HadGEM3-GC31-LL/nino_Q_'+yr1+'.nc')
nino_Q=nino_Q.to_array()
nino_Q=nino_Q.transpose().squeeze()
nino_Q=nino_Q.groupby('time.month')-nino_Q.groupby('time.month').mean('time')
nino_Q=nino_Q.assign_coords(time=range(0,len(nino_Q.time)))
...
ax[10].set_ylabel('net flux (Q, W/m$^2$)')
ax[10].set_title('4xCO$_2$')
ax[10].text(0.85, 0.95, '$\\alpha$='+str("%.2f" % slope1), horizontalalignment='center', verticalalignment='center', transform=ax[10].transAxes)
ax[10].text(0.5, 0.95, '$\\alpha$='+str("%.2f" % slope2), horizontalalignment='center', verticalalignment='center', transform=ax[10].transAxes)
ax[10].text(0.15, 0.95, '$\\alpha$='+str("%.2f" % slope3), horizontalalignment='center', verticalalignment='center', transform=ax[10].transAxes)
...
nino_Q=xr.open_dataset('/Users/ullaheede_1/Documents/ENSO_project/HadGEM3-GC31-LL/nino_Q_'+yr2+'.nc')
nino_Q=nino_Q['__xarray_dataarray_variable__'].isel(time=slice(0,12*85))
nino_Q=nino_Q.groupby('time.month')-nino_Q.groupby('time.month').mean('time')
nino_Q=nino_Q.assign_coords(time=range(0+85*12,len(nino_Q.time)+85*12))
nino_Q_ens2= dsp.bandpass(nino_Q,1/(7*12),1/(1*12),dim='time')

nino_Q=xr.open_dataset('/Users/ullaheede_1/Documents/ENSO_project/HadGEM3-GC31-LL/nino_Q_'+yr3+'.nc')
nino_Q=nino_Q['__xarray_dataarray_variable__'].isel(time=slice(0,12*85))
nino_Q=nino_Q.groupby('time.month')-nino_Q.groupby('time.month').mean('time')
nino_Q=nino_Q.assign_coords(time=range(0+85*12*2,len(nino_Q.time)+85*12*2))
nino_Q_ens3= dsp.bandpass(nino_Q,1/(7*12),1/(1*12),dim='time')
...
ax[11].set_ylabel('net flux (Q, W/m$^2$)')
ax[11].set_title('SSP585 (3 ens. mem. )')
ax[11].text(0.85, 0.95, '$\\alpha$='+str("%.2f" % slope1), horizontalalignment='center', verticalalignment='center', transform=ax[11].transAxes)
ax[11].text(0.5, 0.95, '$\\alpha$='+str("%.2f" % slope2), horizontalalignment='center', verticalalignment='center', transform=ax[11].transAxes)
ax[11].text(0.15, 0.95, '$\\alpha$='+str("%.2f" % slope3), horizontalalignment='center', verticalalignment='center', transform=ax[11].transAxes)
...
nino_Q=xr.open_dataset('/Users/ullaheede_1/Documents/ENSO_project/MIROC6/nino_Q_control.nc')
nino_Q=nino_Q.to_array()
nino_Q=nino_Q.transpose().squeeze()
nino_Q=nino_Q.groupby('time.month')-nino_Q.groupby('time.month').mean('time')
nino_Q=nino_Q.assign_coords(time=range(0,len(nino_Q.time)))
...
ax[15].set_ylabel('net flux (Q, W/m$^2$)')
ax[15].set_title('control')
ax[15].text(0.85, 0.95, '$\\alpha$='+str("%.2f" % slope1), horizontalalignment='center', verticalalignment='center', transform=ax[15].transAxes)
ax[15].text(0.5, 0.95, '$\\alpha$='+str("%.2f" % slope2), horizontalalignment='center', verticalalignment='center', transform=ax[15].transAxes)
ax[15].text(0.15, 0.95, '$\\alpha$='+str("%.2f" % slope3), horizontalalignment='center', verticalalignment='center', transform=ax[15].transAxes)
...
nino_Q=xr.open_dataset('/Users/ullaheede_1/Documents/ENSO_project/MIROC6/nino_Q_'+yr1+'.nc')
nino_Q=nino_Q.to_array()
nino_Q=nino_Q.transpose().squeeze()
nino_Q=nino_Q.groupby('time.month')-nino_Q.groupby('time.month').mean('time')
nino_Q=nino_Q.assign_coords(time=range(0,len(nino_Q.time)))
...
ax[16].set_ylabel('net flux (Q, W/m$^2$)')
ax[16].set_title('4xCO$_2$')
ax[16].text(0.85, 0.95, '$\\alpha$='+str("%.2f" % slope1), horizontalalignment='center', verticalalignment='center', transform=ax[16].transAxes)
ax[16].text(0.5, 0.95, '$\\alpha$='+str("%.2f" % slope2), horizontalalignment='center', verticalalignment='center', transform=ax[16].transAxes)
ax[16].text(0.15, 0.95, '$\\alpha$='+str("%.2f" % slope3), horizontalalignment='center', verticalalignment='center', transform=ax[16].transAxes)
...
nino_Q=xr.open_dataset('/Users/ullaheede_1/Documents/ENSO_project/MIROC6/nino_Q_'+yr2+'.nc')
nino_Q=nino_Q['__xarray_dataarray_variable__'].isel(time=slice(0,12*85))
nino_Q=nino_Q.groupby('time.month')-nino_Q.groupby('time.month').mean('time')
nino_Q=nino_Q.assign_coords(time=range(0+85*12,len(nino_Q.time)+85*12))
nino_Q_ens2= dsp.bandpass(nino_Q,1/(7*12),1/(1*12),dim='time')

nino_Q=xr.open_dataset('/Users/ullaheede_1/Documents/ENSO_project/MIROC6/nino_Q_'+yr3+'.nc')
nino_Q=nino_Q['__xarray_dataarray_variable__'].isel(time=slice(0,12*85))
nino_Q=nino_Q.groupby('time.month')-nino_Q.groupby('time.month').mean('time')
nino_Q=nino_Q.assign_coords(time=range(0+85*12*2,len(nino_Q.time)+85*12*2))
nino_Q_ens3= dsp.bandpass(nino_Q,1/(7*12),1/(1*12),dim='time')
...
ax[17].set_ylabel('net flux (Q, W/m$^2$)')
ax[17].set_title('SSP585 (3 ens. mem. )')
ax[17].text(0.85, 0.95, '$\\alpha$='+str("%.2f" % slope1), horizontalalignment='center', verticalalignment='center', transform=ax[17].transAxes)
ax[17].text(0.5, 0.95, '$\\alpha$='+str("%.2f" % slope2), horizontalalignment='center', verticalalignment='center', transform=ax[17].transAxes)
ax[17].text(0.15, 0.95, '$\\alpha$='+str("%.2f" % slope3), horizontalalignment='center', verticalalignment='center', transform=ax[17].transAxes)
...
nino_Q=xr.open_dataset('/Users/ullaheede_1/Documents/ENSO_project/IPSL-CM6A-LR/nino_Q_control.nc')
nino_Q=nino_Q.to_array()
nino_Q=nino_Q.transpose().squeeze()
nino_Q=nino_Q.groupby('time.month')-nino_Q.groupby('time.month').mean('time')
nino_Q=nino_Q.assign_coords(time=range(0,len(nino_Q.time)))
...
ax[12].set_ylabel('net flux (Q, W/m$^2$)')
ax[12].set_title('control')
ax[12].text(0.85, 0.95, '$\\alpha$='+str("%.2f" % slope1), horizontalalignment='center', verticalalignment='center', transform=ax[12].transAxes)
ax[12].text(0.5, 0.95, '$\\alpha$='+str("%.2f" % slope2), horizontalalignment='center', verticalalignment='center', transform=ax[12].transAxes)
ax[12].text(0.15, 0.95, '$\\alpha$='+str("%.2f" % slope3), horizontalalignment='center', verticalalignment='center', transform=ax[12].transAxes)
...
nino_Q=xr.open_dataset('/Users/ullaheede_1/Documents/ENSO_project/IPSL-CM6A-LR/nino_Q_'+yr1+'.nc')
nino_Q=nino_Q['__xarray_dataarray_variable__'].isel(time=slice(0,12*85))
nino_Q=nino_Q.groupby('time.month')-nino_Q.groupby('time.month').mean('time')
nino_Q=nino_Q.assign_coords(time=range(0,len(nino_Q.time)))
nino_Q_ens1= dsp.bandpass(nino_Q,1/(7*12),1/(1*12),dim='time')

nino_Q=xr.open_dataset('/Users/ullaheede_1/Documents/ENSO_project/IPSL-CM6A-LR/nino_Q_'+yr2+'.nc')
nino_Q=nino_Q['__xarray_dataarray_variable__'].isel(time=slice(0,12*85))
nino_Q=nino_Q.groupby('time.month')-nino_Q.groupby('time.month').mean('time')
nino_Q=nino_Q.assign_coords(time=range(0+85*12,len(nino_Q.time)+85*12))
nino_Q_ens2= dsp.bandpass(nino_Q,1/(7*12),1/(1*12),dim='time')

nino_Q=xr.open_dataset('/Users/ullaheede_1/Documents/ENSO_project/IPSL-CM6A-LR/nino_Q_'+yr3+'.nc')
nino_Q=nino_Q['__xarray_dataarray_variable__'].isel(time=slice(0,12*85))
nino_Q=nino_Q.groupby('time.month')-nino_Q.groupby('time.month').mean('time')
nino_Q=nino_Q.assign_coords(time=range(0+85*12*2,len(nino_Q.time)+85*12*2))
nino_Q_ens3= dsp.bandpass(nino_Q,1/(7*12),1/(1*12),dim='time')
...
ax[14].set_ylabel('net flux (Q, W/m$^2$)')
ax[14].set_title('SSP585 (3 ens. mem. )')
ax[14].text(0.85, 0.95, '$\\alpha$='+str("%.2f" % slope1), horizontalalignment='center', verticalalignment='center', transform=ax[14].transAxes)
ax[14].text(0.5, 0.95, '$\\alpha$='+str("%.2f" % slope2), horizontalalignment='center', verticalalignment='center', transform=ax[14].transAxes)
ax[14].text(0.15, 0.95, '$\\alpha$='+str("%.2f" % slope3), horizontalalignment='center', verticalalignment='center', transform=ax[14].transAxes)
...
nino_Q=xr.open_dataset('/Users/ullaheede_1/Documents/ENSO_project/MIROC-ES2L/nino_Q_control.nc')
nino_Q=nino_Q.to_array()
nino_Q=nino_Q.transpose().squeeze()
nino_Q=nino_Q.groupby('time.month')-nino_Q.groupby('time.month').mean('time')
nino_Q=nino_Q.assign_coords(time=range(0,len(nino_Q.time)))
...
ax[18].set_ylabel('net flux (Q, W/m$^2$)')
ax[18].set_title('control')
ax[18].text(0.85, 0.95, '$\\alpha$='+str("%.2f" % slope1), horizontalalignment='center', verticalalignment='center', transform=ax[18].transAxes)
ax[18].text(0.5, 0.95, '$\\alpha$='+str("%.2f" % slope2), horizontalalignment='center', verticalalignment='center', transform=ax[18].transAxes)
ax[18].text(0.15, 0.95, '$\\alpha$='+str("%.2f" % slope3), horizontalalignment='center', verticalalignment='center', transform=ax[18].transAxes)
...
nino_Q=xr.open_dataset('/Users/ullaheede_1/Documents/ENSO_project/MIROC-ES2L/nino_Q_'+yr1+'.nc')
nino_Q=nino_Q.to_array()
nino_Q=nino_Q.transpose().squeeze()
nino_Q=nino_Q.groupby('time.month')-nino_Q.groupby('time.month').mean('time')
nino_Q=nino_Q.assign_coords(time=range(0,len(nino_Q.time)))
...
ax[19].set_ylabel('net flux (Q, W/m$^2$)')
ax[19].set_title('4xCO$_2$')
ax[19].text(0.85, 0.95, '$\\alpha$='+str("%.2f" % slope1), horizontalalignment='center', verticalalignment='center', transform=ax[19].transAxes)
ax[19].text(0.5, 0.95, '$\\alpha$='+str("%.2f" % slope2), horizontalalignment='center', verticalalignment='center', transform=ax[19].transAxes)
ax[19].text(0.15, 0.95, '$\\alpha$='+str("%.2f" % slope3), horizontalalignment='center', verticalalignment='center', transform=ax[19].transAxes)
...
nino_Q=xr.open_dataset('/Users/ullaheede_1/Documents/ENSO_project/MIROC-ES2L/nino_Q_'+yr1+'.nc')
nino_Q=nino_Q['__xarray_dataarray_variable__']
nino_Q=nino_Q.groupby('time.month')-nino_Q.groupby('time.month').mean('time')
nino_Q=nino_Q.assign_coords(time=range(0,len(nino_Q.time)))
nino_Q_ens1= dsp.bandpass(nino_Q,1/(7*12),1/(1*12),dim='time')

nino_Q=xr.open_dataset('/Users/ullaheede_1/Documents/ENSO_project/MIROC-ES2L/nino_Q_'+yr2+'.nc')
nino_Q=nino_Q['__xarray_dataarray_variable__']
nino_Q=nino_Q.groupby('time.month')-nino_Q.groupby('time.month').mean('time')
nino_Q=nino_Q.assign_coords(time=range(0,len(nino_Q.time)))
nino_Q_ens2= dsp.bandpass(nino_Q,1/(7*12),1/(1*12),dim='time')

nino_Q=xr.open_dataset('/Users/ullaheede_1/Documents/ENSO_project/MIROC-ES2L/nino_Q_'+yr3+'.nc')
nino_Q=nino_Q['__xarray_dataarray_variable__']
nino_Q=nino_Q.groupby('time.month')-nino_Q.groupby('time.month').mean('time')
nino_Q=nino_Q.assign_coords(time=range(0,len(nino_Q.time)))
nino_Q_ens3= dsp.bandpass(nino_Q,1/(7*12),1/(1*12),dim='time')
...
ax[20].set_ylabel('net flux (Q, W/m$^2$)')
ax[20].set_title('SSP585 (1 ens. mem. )')
ax[20].text(0.85, 0.95, '$\\alpha$='+str("%.2f" % slope1), horizontalalignment='center', verticalalignment='center', transform=ax[20].transAxes)
ax[20].text(0.5, 0.95, '$\\alpha$='+str("%.2f" % slope2), horizontalalignment='center', verticalalignment='center', transform=ax[20].transAxes)
ax[20].text(0.15, 0.95, '$\\alpha$='+str("%.2f" % slope3), horizontalalignment='center', verticalalignment='center', transform=ax[20].transAxes)
